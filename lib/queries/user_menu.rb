...
def new_password
    @input_npw1 = @prompt.mask("Please enter your new password")
    @input_npw2 = @prompt.mask("Please enter your new password again to confirm")
end
...
def future_contracts_arr
    ...
    @mpuf = MPuContract.all.map do |contract|
